...
KNOWN_COMMAND_VERBS = ("theme", "icons", "iconset", "mkdir", "touch", "new", "rename", "mv", "delete", "rm", "help", "hint", "?", "zip", "unzip", "extract", "tar", "untar", "context", "tab", "z", "jump", "undo", "redo", "back", "forward")
